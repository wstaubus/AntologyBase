...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <main
      ...
      className="flex-grow w-full max-w-[800px] mx-auto px-6 lg:px-12 py-10"
    >
      {/* Dashboard Header */}
      <div
        id="dashboard-header"
        className="mb-10 border-b border-[#c5c6ce] pb-6 flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4"
      >
        <div>
          <span
            id="dashboard-eyebrow"
            className="font-label-caps text-label-caps text-[#44474d] uppercase tracking-wider mb-2 block text-xs"
          >
            Painel do Projeto
          </span>
          <h1
            id="dashboard-title"
            className="font-display-lg text-display-lg text-[#04162e] text-3xl sm:text-4xl"
          >
            Visão Geral
          </h1>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <span
            ...
            className="px-3 py-1 bg-[#eaeef2] rounded-full font-label-caps text-label-caps text-[#44474d] border border-[#c5c6ce] text-xs font-semibold"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        <div
          ...
          className="col-span-1 md:col-span-2 bg-[#f6fafe] rounded-xl border border-[#c5c6ce] p-6 hover:shadow-[0_4px_20px_rgba(0,0,0,0.05)] transition-all bg-gradient-to-b from-[#ffffff] to-[#f6fafe]"
        >
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-headline-md text-headline-md text-[#04162e] text-lg font-bold">
              Progresso da História
            </h3>
            <span className="material-symbols-outlined text-[#44474d]">
              trending_up
            </span>
          </div>

          <div className="flex flex-col gap-4">
            <div className="flex justify-between font-interface-sm text-interface-sm text-[#44474d] text-sm">
              <span>Meta: {targetWords.toLocaleString('pt-BR')} palavras</span>
              <span className="font-semibold text-[#04162e]">{progressPercent}% Concluído</span>
            </div>

            <div className="w-full bg-[#e4e9ed] rounded-full h-2 overflow-hidden">
              <div
                id="progress-bar-fill"
                className="bg-[#04162e] h-2 rounded-full transition-all duration-500"
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 mt-2">
              <div
                ...
                className="flex flex-col gap-1 p-3 bg-[#f6fafe] rounded border border-[#c5c6ce]"
              >
                <span className="font-label-caps text-label-caps text-[#44474d] text-[11px]">
                  Capítulos
                </span>
                <span className="font-headline-md text-headline-md text-[#04162e] text-xl font-bold">
                  {totalChapters}
                </span>
              </div>
        ...
        <div
          id="card-characters"
          className="bg-[#f6fafe] rounded-xl border border-[#c5c6ce] p-6 hover:shadow-[0_4px_20px_rgba(0,0,0,0.05)] transition-all flex flex-col h-full bg-gradient-to-b from-[#ffffff] to-[#f6fafe]"
        >
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-headline-md text-headline-md text-[#04162e] text-lg font-bold">
              Personagens
            </h3>
            <span className="material-symbols-outlined text-[#44474d]">group</span>
          </div>
          ...
          <div className="flex-grow flex flex-col justify-center py-2">
            ...
            <div className="flex -space-x-4 justify-center mb-5">
              {mainChars.map((char, index) => (
                ...
                >
                  <img
                    className="w-16 h-16 rounded-full border-2 border-[#f6fafe] object-cover shadow-sm"
                    src={char.avatarUrl}
                    alt={char.name}
                  />
                </button>
            ...
            <p
              ...
              className="font-writing-canvas text-writing-canvas text-sm text-center text-[#44474d]"
            >
          ...
          <button
            ...
            className="mt-4 w-full py-2 bg-[#eaeef2] border border-[#c5c6ce] rounded font-interface-sm text-interface-sm text-[#04162e] font-semibold hover:bg-[#dfe3e7] active:scale-[0.98] transition-all cursor-pointer text-center text-xs sm:text-sm"
          >
            Gerenciar Elenco
          </button>
        </div>
        ...
        >
          ...
          <div
            ...
            className="flex-grow relative rounded overflow-hidden mb-4 border border-[#c5c6ce] h-32 cursor-pointer group"
          >
            <div
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-3">
              <span className="font-interface-sm text-interface-sm text-white font-bold block drop-shadow-sm">
                {primaryLocation?.name || 'Nova Alexandria'}
              </span>
            </div>
          </div>

          <p className="font-writing-canvas text-writing-canvas text-sm text-[#44474d] line-clamp-2">
      ...
      <div id="quick-actions-section" className="mb-10">
        <h3 className="font-headline-md text-headline-md text-[#04162e] text-lg font-bold mb-4">
          Ações Rápidas
        </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#04162e] text-[#ffffff] py-4 px-6 rounded shadow-sm hover:opacity-90 active:scale-[0.98] transition-all cursor-pointer font-semibold"
          >
            <span className="material-symbols-outlined text-[22px]">add_circle</span>
            <span className="font-interface-sm text-interface-sm text-sm">
              Novo Capítulo
            </span>
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#f6fafe] border border-[#c5c6ce] text-[#04162e] py-4 px-6 rounded hover:bg-[#dfe3e7] active:scale-[0.98] transition-all cursor-pointer font-semibold shadow-sm"
          >
      ...
      <div
        id="synopsis-callout"
        className="bg-[#eaeef2] border border-[#c5c6ce] rounded-xl p-5 mb-8"
      >
        <div className="flex items-center gap-2 mb-2 text-[#04162e]">
          <span className="material-symbols-outlined text-[18px]">menu_book</span>
          <h4 className="font-headline-md text-xs uppercase tracking-wider font-bold">
            Sinopse & Premissa Central
          </h4>
        </div>
        <p className="font-writing-canvas text-writing-canvas text-sm text-[#44474d] leading-relaxed">
          {project.synopsis}
        </p>
      </div>
    </main>
